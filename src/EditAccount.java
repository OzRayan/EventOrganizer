...
/**
 * EditAccount class extends JPanel..
 * This class prepares a JPanel for the main frame for editing the account.
 *
...
public class EditAccount extends JPanel {
     ...
     */
    public EditAccount(int width, int height) {
        this.width = width;
        this.height = height;
        ...
        // Buttons
        edit = new CreateButton("Update", sv.lightPurple, Color.lightGray, sv.buttonFont);
        edit.setBounds(this.width / 2, 15, 150, 30);

        back = new CreateButton("Back", sv.lightPurple, Color.lightGray, sv.buttonFont);
        back.setBounds(this.width / 2,35 + edit.getHeight(), 150, 30);
